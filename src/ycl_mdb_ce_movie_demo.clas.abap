CLASS ycl_mdb_ce_movie_demo DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_mdb_ce_movie_demo IMPLEMENTATION.
  METHOD if_rap_query_provider~select.

    DATA:
      business_data           TYPE TABLE OF ymdb_c_movie_demo,
      query_result            TYPE ycl_mdb_sdf_movie_api=>ty_result_set,
    ...
    TRY.
        DATA(query) = NEW ycl_mdb_sdf_movie_api( ).
