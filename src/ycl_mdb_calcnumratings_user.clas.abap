CLASS ycl_mdb_calcnumratings_user DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS ycl_mdb_calcnumratings_user IMPLEMENTATION.
    ...
    LOOP AT it_requested_calc_elements INTO DATA(calc_elem).
      ...
      IF calc_elem EQ 'TOTALRATINGS'.
        ...
        LOOP AT lt_original_data REFERENCE INTO DATA(orig).
          ...
          orig->TotalRatings = VALUE #( user_score[ PersonId = orig->PersonId ]-totalratings OPTIONAL ).
