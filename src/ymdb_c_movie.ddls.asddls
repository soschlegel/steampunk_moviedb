   ...
   association [0..*] to YMDB_C_WLIST_MOVIE_CHART as _Chart on $projection.MovieId = _Chart.MovieId
{
  ...
  key     MovieId,
          ...
          ReleaseDate,
          Runtime,
          @ObjectModel.virtualElementCalculatedBy: 'ABAP:ZCL_CALCULATESCORE'
